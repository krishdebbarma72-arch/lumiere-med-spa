    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 sm:gap-3 lg:gap-6">
          ...
          <span className="text-[0.7rem] tracking-wide text-foreground/70 sm:text-sm lg:text-sm">
            (480) 555-0197
          </span>

          <a
            href="#contact"
            className="hidden items-center rounded-2xl bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-transform duration-300 hover:scale-[1.03] md:inline-flex lg:px-6 lg:py-3 lg:text-sm lg:ml-2"
          >
            Book Consultation
          </a>
